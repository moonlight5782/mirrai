...
function harness() {
  ...
  const context = { window, document, navigator: { userAgent: "desktop" }, URL, CustomEvent: class {}, fetch: async url => {
  ...
  return { context, mount: () => window.MirraiWidget.mount({ shopId: "shop", sku: "ALBA", model: "/stale.glb", target: body }), nodes, set: value => { response = value; }, checks: () => checks };
}
