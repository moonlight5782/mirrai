...
export default function Home() {
  ...
  return <main>
    <nav className="nav shell"><button className="brand" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>MIRR<span>AI</span></button><div className="nav-links"><a href="#how">Как работает</a><a href="#catalog">Каталог</a><a href="#business">Для магазинов</a></div><button className="nav-cta" onClick={() => setView("viewer")}>Открыть демо <span>↗</span></button></nav>
