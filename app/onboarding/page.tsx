...
export default async function OnboardingPage() {
  ...
  if (!user) return <main className="onboarding-gate"><a className="brand" href="/">MIRR<span>AI</span></a><section><p>КАБИНЕТ МАГАЗИНА</p><h1>Подключите магазин</h1><span>Войдите, чтобы создать защищённый кабинет и начать подготовку каталога.</span><a href={chatGPTSignInPath("/onboarding")} target="_top">Войти и продолжить <b>→</b></a></section></main>;
