  ...
  return <main className="admin-shell">
    ...
    <section className="admin-main">
      ...
      {data ? <div className="subscription-page">
        ...
        <div className="subscription-actions"><a href="/admin/billing">Расчёт стоимости и заявки</a><a href={`/admin/catalog?shop=${encodeURIComponent(data.shop.slug)}`}>Перейти в каталог →</a></div>
