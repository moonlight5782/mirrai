...
export function SetupWizard({ displayName, shopSlug }: { displayName: string; shopSlug: string }) {
  ...
  const snippet = useMemo(() => data ? `<script src="${origin}/mirrai-widget.js" data-auto="universal" defer></script>` : "", [data, origin]);
